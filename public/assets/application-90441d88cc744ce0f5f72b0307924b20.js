...
//   tilerset = $(".set").fadeTo(0,1);

// $(window).scroll(function(d,h) {
//     tilerset.each(function(i) {
//         a = $(this).offset().top + $(this).height();
//         b = $(window).scrollTop() + $(window).height() + 130 ;
//         if (a < b) $(this).css("background-color", "#ff0000")
//     });
// });
// };
//  $(document).ready(set_position);
//  $(document).on('page:load', set_position);
...
//     $('.big-wrapper').addClass('pt-page-moveToLeft');
...
(function ( $, window, document, undefined ) {
  ...
  var load_curtain = function(){
   ...
   $(document).ready(load_curtain);
 $(document).on('page:load', load_curtain);
       ...
       $('.curtains').curtain({
           ...
           nextSlide: function(){
            ...
            this.$li.each(function(index) {
                ...
                if(cover){
                    $self.css({height: self.$windowHeight, zIndex: 2-index})
                    ...
                    $self.css({minHeight: height, zIndex: 1-index})
